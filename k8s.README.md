...
kubectl create secret generic auth-secrets --from-literal=DATABASE_URL=mongodb+srv://root-user:mongo-db@auth-microservice-db.lpuu5wb.mongodb.net/AuthDB --from-literal=JWT_SECRET=cualquiercosa
```
